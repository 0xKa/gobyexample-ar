...
عنوان الموقع المخطط للنشر: `https://0xKa.github.io/gobyexample-ar/`
...
- ترجمة شروح الأمثلة ومراجعتها: مكتملتان؛ راجع [جدول التقدم](PROGRESS.md).
- المراجعة التحريرية النهائية والمزامنة مع المشروع الأصلي: مكتملتان.
- فحوص CI الخاصة بالترجمة والمخرجات المولّدة: مكتملة.
- النشر عبر GitHub Pages: قيد الإعداد.

اكتمل المحتوى العربي ومراجعته وفحوصه الآلية، وتبقى تهيئة النشر العام.
